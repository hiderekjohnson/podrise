...
- `/podcasts/:podcastSlug/:episodeSlug` — Individual episode recap pages (data in `client/src/data/episodeRecaps.ts`); artwork + title hero, duration display, Apple Podcasts + Spotify listen buttons, TLDL box, What Happened narrative, Key Insights cards, Quote blockquote, prev/next episode nav, signup CTA, related podcasts, full SEO (canonical, OG, twitter tags). Currently 5 My First Million episodes (AI-generated from real Taddy transcripts)
- `/about` — Founder-led About page with Derek Johnson's story (founded Tatango.com, 15 years, semi-retired, built PodCap); sections: hero, origin story, timeline, founder quote, value props, "built for me first," who it's for, What's New link, mini FAQ, final CTA
