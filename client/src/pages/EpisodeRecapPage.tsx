...
import { Lightbulb, Loader2, Sparkles, BookOpen, Globe, Users, Building2, ChevronRight, Megaphone, ExternalLink, Ticket, Copy, Check, Quote, X, ArrowUp, Clock, ShoppingBag, Bookmark, BookmarkCheck, Heart, ListChecks, ArrowRight, ArrowLeft, Lock, Mail, Play, Pause, Headphones } from "lucide-react";
...
function RecapAudioPlayer({ podcastSlug, episodeSlug }: { podcastSlug: string; episodeSlug: string }) {
...
export default function EpisodeRecapPage() {
  ...
  const recapContent = (
      ...
      >
        ...
        {isLoggedIn && podcastSlug === "my-first-million" && (
          <RecapAudioPlayer podcastSlug={podcastSlug} episodeSlug={episodeSlug} />
        )}
