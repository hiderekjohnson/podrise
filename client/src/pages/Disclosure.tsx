      ...
      <main className="flex-1 w-full">
        ...
        >
          ...
          <div className="space-y-4 text-[17px] leading-[1.85] text-[#52525B] max-w-2xl">
            ...
            <p>
              Email <a href="mailto:derek@podcap.io" className="text-primary font-medium hover:underline" data-testid="link-email-derek">derek@podcap.io</a> or reach us through our <Link href="/contact" className="text-primary font-medium hover:underline" data-testid="link-contact-page">contact page</Link> or <Link href="/support" className="text-primary font-medium hover:underline" data-testid="link-support-page">support page</Link>.
            </p>
          </div>
        </motion.section>
      </main>
