                ...
                {visibleEpisodes.map((ep: any) => (
                  isLoggedIn ? (
                    <RecapCard
                      ...
                      podcastSlug={slug}
                      podcastName={ep.podcastName || config.name}
                      episodeTitle={ep.episodeTitle}
                      publishDate={ep.publishDate}
                      artworkUrl={ep.artworkUrl || config.artworkUrl}
                      tldl={ep.tldl}
                      ...
                      hosts={ep.pdHosts || podcastConfig?.hosts || undefined}
                      totalEpisodes={ep.pdTotalEpisodes || podcastConfig?.totalEpisodes || undefined}
                      yearStarted={ep.pdYearStarted || podcastConfig?.yearStarted || undefined}
