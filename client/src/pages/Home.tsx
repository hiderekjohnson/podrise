...
const MOCK_PODCASTS = [
  { id: '1', name: 'Joe Rogan Experience', initials: 'JR', color: 'bg-red-100 text-red-700' },
  { id: '2', name: 'All-In Podcast', initials: 'AI', color: 'bg-blue-100 text-blue-700' },
  { id: '3', name: 'Huberman Lab', initials: 'HL', color: 'bg-emerald-100 text-emerald-700' },
  { id: '4', name: 'Acquired', initials: 'AC', color: 'bg-purple-100 text-purple-700' },
  { id: '5', name: 'My First Million', initials: 'MM', color: 'bg-amber-100 text-amber-700' },
  { id: '6', name: 'Lex Fridman Podcast', initials: 'LF', color: 'bg-slate-100 text-slate-700' },
  { id: '7', name: 'Invest Like the Best', initials: 'IB', color: 'bg-indigo-100 text-indigo-700' },
  { id: '8', name: 'The Daily', initials: 'TD', color: 'bg-rose-100 text-rose-700' },
];
...
export default function Home() {
  ...
  const filteredPodcasts = useMemo(() => {
    if (!searchQuery) return MOCK_PODCASTS;
    ...
    createSubscription(
      ...
      },
      {
        onSuccess: () => {
          toast({
            title: "Success! 🎉",
            description: "Check your email for your first daily brief.",
          });
          // Reset form
          ...
          <div className="ml-0 sm:ml-11 space-y-6">
            ...
            <div className="space-y-4 pt-4">
              <button
                ...
                disabled={isPending}
                className="w-full h-16 flex items-center justify-center gap-2 rounded-2xl font-display font-bold text-lg bg-primary text-primary-foreground shadow-xl shadow-primary/25 hover:shadow-primary/40 hover:-translate-y-0.5 active:translate-y-0 active:shadow-md disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                {isPending ? (
                  <>
