...
import { Loader2, MessageCircle, Bookmark, BookmarkCheck, Share, ChevronDown, Copy, ExternalLink, Gift, ChevronRight, MoreHorizontal } from "lucide-react";
...
function FeedCardBottomBar({ item, isBookmarked, onBookmarkToggle, onFollowToggle, toast }: {
  item: FeedItem;
