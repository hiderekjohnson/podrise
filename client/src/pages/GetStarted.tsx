...
function SEOHead() {
  ...
  const description = "Choose your favorite podcasts and get a personalized daily recap email. Skip the 2-hour episodes and get the key ideas in a 2-minute read.";
