...
const APPLE_URL = "https://podcasts.apple.com/us/podcast/my-first-million/id1469759170";
const SPOTIFY_URL = "https://open.spotify.com/show/3mliji9352UAk3XnWElnDV";

const FAQ_ITEMS = [
  {
    q: "What is PodCap's My First Million daily summary?",
    a: "PodCap delivers a concise AI-powered recap of the latest My First Million podcast episodes straight to your inbox every morning. Each summary covers the key business ideas, side hustles, startup strategies, and money-making opportunities discussed by Sam Parr and Shaan Puri — so you stay informed even when you don't have time to listen.",
  },
  {
    q: "How does the My First Million podcast summary work?",
    a: "Every day, PodCap checks for new My First Million episodes, pulls real transcripts when available, and uses AI to generate a detailed digest. You'll get the biggest takeaways, specific insights, memorable quotes, and conversation starters — all formatted for a quick read over your morning coffee.",
  },
  {
    q: "Is this an official My First Million product?",
    a: "No. PodCap is an independent podcast summary service and is not affiliated with, endorsed by, or sponsored by My First Million, Sam Parr, Shaan Puri, or the Hubspot Podcast Network. We're fans who built a tool to help other fans keep up with the show.",
  },
  {
    q: "Can I get summaries of other podcasts too?",
    a: "Yes! Once you create your free PodCap account, you can add up to 3 podcasts to your daily digest. Popular choices include All-In Podcast, The Tim Ferriss Show, Acquired, and hundreds more. Upgrade to PodCap Pro for unlimited podcasts.",
  },
  {
    q: "What topics does My First Million cover?",
    a: "My First Million is a business podcast hosted by Sam Parr and Shaan Puri that covers startup ideas, side hustle opportunities, business trends, SaaS, e-commerce, creator economy, wealth building, entrepreneurship frameworks, and interviews with successful founders and investors.",
  },
  {
    q: "When will I receive my daily My First Million summary?",
  ...
  },
  {
    ...
    a: "PodCap is free for up to 3 podcasts. If you want unlimited podcast summaries, you can upgrade to PodCap Pro for $9.99/month. The My First Million summary is included in the free plan.",
  },
  {
    q: "What if My First Million doesn't release an episode today?",
    a: "PodCap only sends you a digest when there are new episodes. If My First Million (or your other selected podcasts) didn't release anything, you won't receive an empty email — we respect your inbox.",
  },
];

export default function PodcastLandingMFM() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    register(
      {
        podcasts: [JSON.stringify(MFM_PODCAST)],
        email,
      },
      {
        onSuccess: () => {
          toast({ title: "You're in!", description: "Your My First Million digest is set up. Redirecting..." });
          navigate("/dashboard");
        },
        onError: (err) => {
          toast({
          ...
          >
            ...
            >
              <div className="relative">
                ...
                <img
                  src={MFM_PODCAST.artworkUrl}
                  alt="My First Million Podcast Cover Art"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <div className="glass-panel rounded-2xl p-6 flex flex-col items-center text-center gap-3" data-testid="feature-ai">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Real transcript analysis extracts the best business ideas, quotes, and
                actionable insights from every My First Million episode.
              </p>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 flex flex-col items-center text-center gap-3" data-testid="feature-time">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Each episode is 45–90 minutes. Your PodCap recap takes 5 minutes to read
      ...
      <footer className="w-full border-t border-black/[0.06] py-8 px-6">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-muted-foreground/60 text-center">
            PodCap is not affiliated with My First Million, Sam Parr, Shaan Puri, or HubSpot Podcast Network.
