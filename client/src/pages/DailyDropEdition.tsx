...
function normalizeLink(href: string): string {
  ...
  if (cleaned.startsWith("/podcasts/") || cleaned.startsWith("/people/") || cleaned.startsWith("/companies/") || cleaned.startsWith("/topics/") || cleaned.startsWith("/insights/") || cleaned.startsWith("/daily-drop")) {
    return cleaned;
  }
