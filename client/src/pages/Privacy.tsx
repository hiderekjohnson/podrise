      ...
      <main className="flex-1 w-full max-w-3xl mx-auto px-6 py-10">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-foreground/80">
          ...
          <section>
            ...
            <p>We retain your personal information for as long as your account is active or as needed to provide you with the Service. You may request deletion of your account and associated data by contacting us at the email address below.</p>
          </section>
          ...
          <section>
            ...
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@podcap.io" className="text-primary hover:underline">support@podcap.io</a>.</p>
          </section>
        </div>
      </main>
