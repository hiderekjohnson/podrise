...
export const COMPANIES_DIRECTORY: CompanyEntry[] = [
  ...
  },
  {
    ...
    searchTerms: ["Google", "Alphabet", "DeepMind", "Google DeepMind", "Google Cloud", "Google Cloud Platform", "GCP"],
    associatedTerms: ["Gemini", "DeepMind", "Google Cloud", "Android", "Chrome"],
    details: {
  ...
  },
  {
    ...
    searchTerms: ["Microsoft", "Microsoft AI", "Copilot", "Microsoft Azure", "Azure"],
  ...
  },
  {
    ...
    searchTerms: ["Amazon", "Amazon Web Services", "AWS"],
