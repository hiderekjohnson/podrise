...
export const LANDING_PAGES: LandingPageConfig[] = [
  {
    ...
    subheadline: "PodCap distills the best podcast episodes into quick, actionable summaries so you stay informed without the time commitment.",
  ...
  },
  {
    ...
    subheadline: "Founders and executives use PodCap to track industry trends, competitive moves, and expert opinions across hundreds of business podcasts.",
