          ...
          <div className="p-3 border-b border-black/[0.06]">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-10 pl-9 pr-4 bg-black/[0.03] border border-black/[0.06] rounded-xl text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary/30 transition-all font-medium placeholder:text-muted-foreground/40"
              />
            </div>
          </div>
          ...
          <div ref={listRef} className="max-h-72 overflow-y-auto overscroll-contain">
              ...
              <div className="px-3 pt-3 pb-1">
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{getCurrentOffset(detectedTz)} · {getCurrentTime(detectedTz)}</p>
                  </div>
                </button>
              </div>
            )}
              ...
              <div className="px-3 pt-3 pb-1">
                ...
                {popularFiltered.map((tz) => (
                  ...
                  >
                    ...
                    <span className="text-xs text-muted-foreground shrink-0 tabular-nums">{getCurrentOffset(tz)}</span>
            ...
            {search && popularFiltered.length === 0 && otherFiltered.length === 0 && (
              <div className="px-4 py-8 text-center">
                <p className="text-sm text-muted-foreground">No timezones match "{search}"</p>
              </div>
            )}
          </div>
