...
- keyInsights: Each takeaway must be a complete standalone idea that delivers genuine value. The test: if someone read only this bullet and never listened to the episode, would they have learned something specific and useful? If not, rewrite it. Each takeaway should be 2-3 sentences that could be read out of context and still be worth reading. NEVER use the words "discusses", "explores", "highlights", "shares", "emphasizes", "explains", "points out", "praises", "recounts", "acknowledges", "underscores", or "reveals". NEVER name the speaker and describe what they talked about. NEVER write "[Person] [verb] [topic]". Instead write the actual insight itself. Include specific names, companies, numbers, or examples from the episode to keep it concrete - but frame them as part of the insight, not as attribution. BAD: "Bill Gurley discusses the transformative impact of AI on the workplace and warns that those resistant to change risk being replaced." GOOD: "AI acts as a multiplier for curious, proactive people and a threat to passive ones. The gap between those two groups is going to widen quickly, and which side you land on is largely a choice."
