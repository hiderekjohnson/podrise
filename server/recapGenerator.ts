...

{
  ...
  "keyInsights": ["[Speaker Name] argues [specific claim], pointing to [named example - person, company, book, or story]", "Insight 2 with named speaker and concrete reference", "Insight 3 with named speaker and concrete reference", "Insight 4 with named speaker and concrete reference"],
