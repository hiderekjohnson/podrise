...
- topicContexts: DO NOT create slugs from keyTopics. Instead, identify which of these predefined broad categories apply to this episode, and write a 1-2 sentence episode-specific description for each relevant one. ONLY use these exact slugs as keys: "ai", "entrepreneurship", "startups", "venture-capital", "investing", "personal-finance", "leadership", "marketing", "sales", "productivity", "decision-making", "technology", "economics", "future-of-work", "health-longevity", "psychology", "peak-performance", "self-improvement", "negotiation", "career-growth", "creativity", "media-content", "geopolitics", "creator-economy", "saas", "open-source", "product-management", "product-market-fit", "automation", "robotics", "crypto-web3", "climate-energy", "defense-tech", "women-in-business", "young-entrepreneurs", "bootstrapping", "side-hustles". Only include categories that are genuinely discussed in the episode (typically 3-6). Reference specific points, people, or perspectives from this episode. Write like a sharp analyst, not generic marketing copy
